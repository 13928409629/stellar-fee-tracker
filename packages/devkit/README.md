...
DevKit provides a redesigned v2 command-line interface with unified binary entry `devkit`. It delivers a full suite of utilities for Stellar XLM/Stroops conversion, configuration validation, data inspection, environment diagnosis and workspace configuration management.
